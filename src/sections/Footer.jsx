...
const Footer = () => {
  return (
    <footer className="max-container">
      <div className="flex justify-between items-center gap-20 flex-wrap lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <div className="flex items-center gap-5 mt-8">
            {socialMedia.map((icon) => (
              <div key={icon} className="flex justify-center items-center h-12 w-12 bg-white rounded-full">
                <img
                  src={icon.src}
                  alt={icon.alt}
                  width={24}
